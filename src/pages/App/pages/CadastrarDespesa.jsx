  ...
  return (
    <div className="w-full bg-gray-900">
      <div className="max-w-3xl mx-auto h-screen flex flex-col justify-center items-center space-y-5 p-4">
        <h2 className="font-bold text-4xl text-green-500">Cadastrar gasto:</h2>
        <p className="text-base font-medium text-gray-400">
          Preencha os dados abaixo
        </p>
        <form
          onSubmit={handleSubmit}
          className="w-full flex flex-col space-y-5 p-6 border border-gray-600 rounded-lg bg-gray-800 shadow-lg"
        >
          ...
          <div className="flex flex-col items-center">
            ...
            {response.loading && (
              <button
                disabled
                className="font-bold text-2xl text-gray-200 bg-gray-600 cursor-pointer border border-gray-700 rounded-lg w-1/2 p-2"
              >
                Aguarde...
              </button>
            )}
